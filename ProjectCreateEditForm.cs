...
namespace HumanitarianProjectManagement.Forms
{
    public partial class ProjectCreateEditForm : Form
    {
        ...
        private void ApplyLocalization()
        {
            ...
            // Localize Labels
            this.lblProjectName.Text = resources.GetString("lblProjectName.Text");
            this.lblProjectCode.Text = resources.GetString("lblProjectCode.Text");
            this.lblOverallObjective.Text = resources.GetString("lblOverallObjective.Text");
            this.lblLocation.Text = resources.GetString("lblLocation.Text");
            this.lblStartDate.Text = resources.GetString("lblStartDate.Text");
            this.lblEndDate.Text = resources.GetString("lblEndDate.Text");
            this.lblStatus.Text = resources.GetString("lblStatus.Text");
            this.lblTotalBudget.Text = resources.GetString("lblTotalBudget.Text");
            this.lblDonor.Text = resources.GetString("lblDonor.Text");
            this.lblSection.Text = resources.GetString("lblSection.Text");
            this.lblManager.Text = resources.GetString("lblManager.Text");
